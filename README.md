...
Для успешного запуска проекта локально необходимо проделать следующее:
  ...
  7. Создать пустую базу данных (данные для DB_HOST, DB_PORT, DB_DATABASE, DB_USERNAME и DB_PASSWORD из вновь созданной базы данных запомнить или записать!!!!)  
...
### Посмотреть проект в работе можно [здесь](https://www.gronikweb.h1n.ru/)
