    ...
    return (
        <section className={`space-y-6 ${className}`}>
            <header>
                ...
                Как только ваша учетная запись будет удалена, все ее ресурсы и данные будут удалены безвозвратно. Прежде
                    чем удалить свою учетную запись, пожалуйста, загрузите любые данные или информацию, которые вы хотите сохранить.
                </p>
            </header>
            ...
            <Modal show={confirmingUserDeletion} onClose={closeModal}>
                <form onSubmit={deleteUser} className="p-6">
                    ...
                    <div className="mt-6 flex justify-end">
                        <SecondaryButton onClick={closeModal}>закрыть</SecondaryButton>
